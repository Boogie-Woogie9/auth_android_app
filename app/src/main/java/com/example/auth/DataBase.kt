...
class DataBase(val context: Context, val factory: SQLiteDatabase.CursorFactory?) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db.execSQL("INSERT INTO users VALUES(1, \"User1\", \"rtyfoo\")")
        db.execSQL("INSERT INTO users VALUES(2, \"User2\", \"12345678\")")
        db.execSQL("INSERT INTO users VALUES(3, \"User3\", \"cvbn\")")
    }
